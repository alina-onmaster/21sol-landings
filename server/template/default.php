...
//	$PAGE['title'] = 'Õîä ñòðîèòåëüñòâà - '.$PAGE['title'];
...
if($PAGE['id'] != 1 && $PAGE['parent_id'] != 0) echo "<div class='navigation'><a href='/'>ãëàâíàÿ</a> <span style='font-size:8px'>/</span> ".strtolower(navigation_line())."</div>";
...
if($PAGE['parent_id'] == 22697 && !empty($PAGE['pics']) && $PAGE['id'] != 23405 && $PAGE['id'] != 23505){
	if ($PAGE['id'] == 23405) {
		echo '<p class="prod_desc">9-òè ýòàæíûé äîì ñ âåíòèëèðóåìûì ôàñàäîì è àâòîíîìíûì îòîïëåíèåì ïî óë. Àñëàìàñà, ðÿäîì ñ ÃÏ "Ëåíòà"</p>';
	}
	if ($PAGE['id'] == 23440) {
